...
public class ImageMemoryAccessor : IImageMemoryAccessor
{
    private readonly IWebHostEnvironment _environment;
    private readonly ILogger<ImageMemoryAccessor> _logger;
    private readonly IOriginAccessor _originAccessor;
    public ImageMemoryAccessor(IWebHostEnvironment environment, IOriginAccessor originAccessor, ILogger<ImageMemoryAccessor> logger)
    {
